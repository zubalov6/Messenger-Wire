    ...
    <div className="auth">
      <div className="auth__frame">
        ...
        <div className="auth__panel">
          <h1 className="auth__heading">Новое подключение</h1>
          <p className="auth__lede">Придумайте логин и пароль, чтобы открыть мессенджер.</p>
          ...
          <form onSubmit={submit} noValidate>
            ...
            <div className="field">
              <label className="field__label" htmlFor="confirm">Повтор пароля</label>
              <input
                id="confirm"
                type="password"
                className="field__input"
        ...
        <p className="auth__foot">
          Уже есть аккаунт? <Link className="auth__link" to="/login">Войти</Link>
        </p>
      </div>
    </div>
  );
